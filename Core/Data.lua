...
ns.ITEM_TAGS = {
    ---- TradeGoods
    Cloth = {
        14342, 14256, 14341, 14227, 14048, 14047, 4338, 3182, 2592, 4306, 2589, 10285, 4339, 4337, 2320, 4305, 2321,
        2997, 8343, 2996, 4291,
    },
    Leather = {
        12810, 15416, 15407, 15409, 8170, 15417, 17012, 8150, 8167, 4234, 4304, 8165, 7392, 2319, 4461, 5784, 15410,
        8154, 2318, 15419, 4235, 15414, 783, 15415, 15412, 5785, 8171, 5082, 4232, 7286, 15408, 8172, 4289, 20381, 4233,
        4236, 2934, 4231, 19767, 8169, 17967, 19768, --
        --
        7428, 8368, 15423, 15422, 15423,
    },
    ['Metal & Stone'] = {
        12360, 17771, 11371, 18562, 12809, 10620, 12655, 7912, 2836, 11370, 18567, 12359, 3858, 17203, 12644, 3859,
        12365, 3857, 2838, 2772, 2841, 2775, 2835, 3860, 7911, 2771, 3486, 6037, 2840, 3478, 3575, 2770, 2842, 7966,
        3577, 3470, 2776, 3576, 22203, 22202, 11099, 3861,
    },
    Cooking = {
        13759, 7974, 12207, 12208, 13888, 21153, 5504, 12203, 6308, 21071, 13889, 12037, 4603, 8365, 12205, 13754,
        13760, 5503, 20424, 13756, 3731, 2677, 3685, 2674, 13758, 12202, 3173, 3712, 3174, 3404, 769, 2673, 12184, 3667,
        2672, 6361, 1015, 730, 5465, 6289, 6291, 21024, 6889, 6362, 2251, 5471, 1468, 12206, 3172, 2675, 3730, 8959,
        5469, 5470, 5466, 729, 6303, 1080, 4655, 723, 5468, 2886, 2924, 731, 12223, 12204, 5467, 6317, --
        --
        1081,
    },
    Herb = {
        13468, 13463, 13465, 3819, 8845, 13466, 8846, 8838, 8831, 8839, 4625, 3821, 3818, 13467, 2452, 13464, 3369,
        8153, 3820, 3355, 8836, 19726, 3357, 3358, 3356, 2450, 2453, 785, 2449, 2447, 19727, 765,
    },
    Elemental = {7068, 7067, 7080, 7082, 12803, 7078, 7076, 7070, 7077, 10286, 7069, 7972, 12808, 7079, 7075, 7081},
    Enchanting = {
        16203, 16206, 14344, 6338, 16204, 14343, 16202, 11128, 16207, 10940, 6217, 11144, 10938, 6218, 10939, 6339,
        11145, 11130, 6374, 6216, 20725, 11177, 11176, 11175, 11174, 11178, 11083, 11137, 10998, 11082, 11135, 11134,
        10978, 11139, 11084, 11138,
    },
    Jewelry = {12363, 11382, 12361, 12800, 7910, 12364, 12799, 1206, 1529, 1210, 7909, 1705, 3864, 818, 774},
    ---- Others
    Mount = {
        1041, 1132, 1133, 1134, 12302, 12303, 12325, 12326, 12327, 12330, 12351, 12353, 12354, 13086, 13317, 13321,
        13322, 13323, 13324, 13325, 13326, 13327, 13328, 13329, 13331, 13332, 13333, 13334, 13335, 14062, 15277, 15290,
        15292, 15293, 16338, 16339, 16343, 16344, 18241, 18242, 18243, 18244, 18245, 18246, 18247, 18248, 18766, 18767,
        18768, 18772, 18773, 18774, 18776, 18777, 18778, 18785, 18786, 18787, 18788, 18789, 18790, 18791, 18793, 18794,
        18795, 18796, 18797, 18798, 18902, 19029, 19030, 19872, 19902, 20221, 21176, 21218, 21321, 21323, 21324, 21736,
        23193, 23720, 2411, 2413, 2414, 2415, 5655, 5656, 5663, 5665, 5668, 5864, 5872, 5873, 5874, 5875, 8563, 8583,
        8586, 8588, 8589, 8590, 8591, 8592, 8595, 8627, 8628, 8629, 8630, 8631, 8632, 8633, 875, 901,
    },
    Pet = {
...
-- @bcc@
ns.ITEM_TAGS = {
    [GetItemSubClassInfo(LE_ITEM_CLASS_MISCELLANEOUS, LE_ITEM_MISCELLANEOUS_MOUNT)] = {
        34061, -- [涡轮加速飞行器控制台]
        34060, -- [飞行器控制台]
        33189, -- [摇摇晃晃的魔法扫帚]
        21176, -- [黑色其拉共鸣水晶]
    ...
    [GetItemSubClassInfo(LE_ITEM_CLASS_MISCELLANEOUS, LE_ITEM_MISCELLANEOUS_COMPANION_PET)] = {

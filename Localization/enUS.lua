...
-- [comment by wct] -- [comment by wct] L['KEYWORD_CLASS'] = 'Classes'
...
-- [comment by wct] -- [comment by wct] L['Saving rules'] = true
...
-- [comment by wct] -- [comment by wct] L['Sorting rules'] = true

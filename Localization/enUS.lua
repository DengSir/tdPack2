...
-- [comment by wct] L['Add extension filter to LibItemSearch-1.2'] = true
L['Add rule'] = true
L['Advancee rules use ItemSearch-1.3'] = true
-- [comment by wct] L['Advancee rules use LibItemSearch-1.2'] = true
...
-- [comment by wct] L['Are you sure to |cffff1919RESET|r saving rules?'] = true
-- [comment by wct] L['Are you sure to |cffff1919RESET|r sorting rules?'] = true
L['Are you sure you want to restore the current Settings?'] = true
L['Bag'] = true
-- [comment by wct] L['Bag button features'] = true
L['Bank'] = true
L['Bank and bag stacking together'] = true
-- [comment by wct] L['Bank button features'] = true
L['Buttons'] = true
L['Character Specific Settings'] = true
-- [comment by wct] L['COMMENT_CLASS'] = 'Class items'
-- [comment by wct] L['COMMENT_MOUNT'] = 'Mount'
L['Drag to modify the sorting order'] = true
L['Edit rule'] = true
L['Enable chat message'] = true
L['Enjoy!'] = true
-- [comment by wct] L['Global'] = true
L['Help'] = true
-- [comment by wct] L['ITEM_TAG: Cloth'] = 'Cloth'
-- [comment by wct] L['ITEM_TAG: Cooking'] = 'Cooking'
-- [comment by wct] L['ITEM_TAG: Elemental'] = 'Elemental'
-- [comment by wct] L['ITEM_TAG: Enchanting'] = 'Enchanting'
-- [comment by wct] L['ITEM_TAG: Herb'] = 'Herb'
-- [comment by wct] L['ITEM_TAG: Jewelry'] = 'Jewelry'
-- [comment by wct] L['ITEM_TAG: Leather'] = 'Leather'
-- [comment by wct] L['ITEM_TAG: Metal & Stone'] = 'Metal & Stone'
-- [comment by wct] L['ITEM_TAG: Mount'] = 'Mount'
-- [comment by wct] L['ITEM_TAG: Pet'] = 'Pet'
L['Keep bank items stack full'] = true
-- [comment by wct] L['KEYWORD_CLASS'] = 'Classes'
-- [comment by wct] L['KEYWORD_MOUNT'] = 'Summons and dismisses'
...
L['Put where?'] = true
L['Reset rule'] = true
-- [comment by wct] L['Reset saving rules'] = true
-- [comment by wct] L['Reset sorting rules'] = true
...
-- [comment by wct] L['Saving rules'] = true
-- [comment by wct] L['SAVING_DESC'] = 'Save items to bank.'
-- [comment by wct] L['SAVING_NAME'] = 'Saving'
...
-- [comment by wct] L['Sorting rules'] = true
-- [comment by wct] L['SORTING_DESC'] = 'Sort bags and bank.'
-- [comment by wct] L['SORTING_NAME'] = 'Sorting'

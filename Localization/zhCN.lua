...
L['Bank'] = '银行'
L['Reset rule'] = '重置'
L['Are you sure to |cffff1919RESET|r rules?'] = '你确定|cffff1919重置|r规则？'
L['Profile'] = '配置文件'

-- [comment by wct] L['SORTING_NAME'] = '整理'
-- [comment by wct] L['SORTING_DESC'] = '整理背包和银行。'
-- [comment by wct] L['SAVING_NAME'] = '保存'
-- [comment by wct] L['SAVING_DESC'] = '保存物品到银行。'
...
-- rules comment
-- [comment by wct] L.COMMENT_CLASS = '职业物品'

-- for rules
-- [comment by wct] L.KEYWORD_CLASS = '职业：'

L.Tools = '工具'
L.Transporter = '传送器'
L.Usuable = '常用'

-- [comment by wct] L['ITEM_TAG: Cloth'] = '布'
-- [comment by wct] L['ITEM_TAG: Leather'] = '皮'
-- [comment by wct] L['ITEM_TAG: Metal & Stone'] = '金属和矿石'
-- [comment by wct] L['ITEM_TAG: Cooking'] = '烹饪'
-- [comment by wct] L['ITEM_TAG: Herb'] = '草药'
-- [comment by wct] L['ITEM_TAG: Elemental'] = '元素'
-- [comment by wct] L['ITEM_TAG: Enchanting'] = '附魔'
-- [comment by wct] L['ITEM_TAG: Jewelry'] = '宝石'
-- [comment by wct] L['ITEM_TAG: Mount'] = '坐骑'
-- [comment by wct] L['ITEM_TAG: Pet'] = '宠物'
